...
object AwsDynamoDbLocalTestUtils {
     ...
     */
    @JvmOverloads
    fun initSqLite(libPathSupplier: Supplier<String> = Supplier {
        val classPath = getClassPathList(System.getProperty("java.class.path"), File.pathSeparator)
        val libPath = getLibPath(System.getProperty("os.name"), System.getProperty("java.runtime.name"),
 ...
 * class](https://bitbucket
    ...
    fun getClassPathList(classPath: String, pathSeparator: String?): List<String> {
        return Arrays.asList(*classPath.split(pathSeparator!!).toTypedArray())
    }
}